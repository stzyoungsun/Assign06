package framework.texture
{
	...
	public class TextureManager
	{
		...
		public function addTexture(textureName:String, texture:FwTexture):void
		{
		...
		public function createAtlasTexture():void
		{
			...
			for(var textureName:String in _textureDictionary)
			{
				...
				if(checkXml(xmlName))
				{
					_atlasTextureDictionary[textureName] = new AtlasTexture(_textureDictionary[textureName], _xmlDictionary[xmlName]);
				}
			}
		}
