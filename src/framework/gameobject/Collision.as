package framework.gameobject
{
	...
	public class Collision
	{
		...
		public static function bulletToObject(bullet:Bullet, object:DisplayObject):Boolean
		{
			...
			if(bulletRectangle.left < objectRectangle.right && bulletRectangle.top < objectRectangle.bottom && 
				bulletRectangle.right > objectRectangle.left && bulletRectangle.bottom > objectRectangle.top)
				return true;
