package framework.gameobject
{
	...
	public class Collision
	{
		...
		{
			var tempwidth2 : Number  = object2.width*0.7;				//물체의 스케일을  0.7로 하여 충돌 검사 (애매한 경우를 처리하기 위해서)
			...
			var tempwidth1 : Number  = object1.width*0.7;				//물체의 스케일을  0.7로 하여 충돌 검사 (애매한 경우를 처리하기 위해서)
